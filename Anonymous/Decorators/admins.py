...
from Anonymous.Database import (_get_authusers, add_nonadmin_chat,
                            delete_authuser, get_authuser, get_authuser_count,
                            get_authuser_names, is_nonadmin_chat,
                            remove_nonadmin_chat, save_authuser)
from Anonymous.Utilities.changers import int_to_alpha
                ...
                if message.from_user.id not in SUDOERS:
                    ...
                    if token not in _check:
                        return await message.reply(
                            "Yᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴛʜᴇ ʀᴇǫᴜɪʀᴇᴅ ᴘᴇʀᴍɪssɪᴏɴ ᴛᴏ ᴘᴇʀғᴏʀᴍ ᴛʜɪs ᴀᴄᴛɪᴏɴ ʙᴀʙʏ.\n\n__Rᴇǫᴜɪʀᴇs ᴀᴅᴍɪɴ ᴡɪᴛʜ ᴍᴀɴᴀɢᴇ VC ʀɪɢʜᴛs.__"
                        )
