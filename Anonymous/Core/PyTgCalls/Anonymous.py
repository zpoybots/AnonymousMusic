...
from Anonymous import MUSIC_BOT_NAME, app, db_mem, userbot
from Anonymous.Core.PyTgCalls import Queues
from Anonymous.Core.PyTgCalls.Converter import convert
from Anonymous.Core.PyTgCalls.Downloader import download
from Anonymous.Database import remove_active_chat
from Anonymous.Inline import (audio_markup, audio_timer_markup_start,
        ...
        if Queues.is_empty(chat_id):
            ...
            if str(finxx) != "raw":
                mystic = await app.send_message(
                    chat_id,
                    "**Playlist Function**\n\n__Dᴏᴡɴʟᴏᴀᴅɪɴɢ ɴᴇxᴛ ᴍᴜsɪᴄ ғʀᴏᴍ ᴘʟᴀʏʟɪsᴛ ʙᴀʙʏ...__",
                )
                (
                    title,
                    duration_min,
                ...
                mystic = await mystic.edit(
                    f"**{MUSIC_BOT_NAME} Dᴏᴡɴʟᴏᴀᴅᴇʀ ʙᴀʙʏ**\n\n**Tɪᴛʟᴇ:** {title[:50]}\n\n0% â–“â–“â–“â–“â–“â–“â–“â–“â–“â–“â–“â–“ 100%"
                )
                ...
                finaltext = await app.send_photo(
                    ...
                    caption=(
                        f"ðŸŽ¥<b>__Sᴛᴀʀᴛᴇᴅ ᴘʟᴀʏɪɴɢ:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={afk}) \nðŸ‘¤**__Rᴇǫᴜᴇsᴛᴇᴅ ʙʏ:__** {mention} ʙᴀʙʏ"
                    ),
                )
                os.remove(thumb)
                videoid = afk
                ...
                finaltext = await app.send_photo(
                    ...
                    photo=thumb,
                    reply_markup=InlineKeyboardMarkup(buttons),
                    caption=f"ðŸŽ¥<b>__Sᴛᴀʀᴛᴇᴅ ᴘʟᴀʏɪɴɢ:__</b> {title} \nðŸ‘¤<b>__Rᴇǫᴜᴇsᴛᴇᴅ ʙʏ:__ </b> {mention} ʙᴀʙʏ",
                )
            await start_timer(
                videoid,
                duration_min,
