...
from Anonymous.Utilities.download import get_formats, get_type
...
» ʙᴀɴ ᴀ ᴜsᴇʀ ɢʟᴏʙᴀʟʟʏ ɪɴ ʙᴏᴛ's sᴇʀᴠᴇᴅ ᴄʜᴀᴛs ᴀɴᴅ ᴘʀᴇᴠᴇɴᴛs ᴜsᴇʀ ꜰʀᴏᴍ ᴜsɪɴɢ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs.​

/ungban [ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴜsᴇʀ]
» ʀᴇᴍᴏᴠᴇ ᴀ ᴜsᴇʀ ꜰʀᴏᴍ ʙᴏᴛ's ɢʙᴀɴ ʟɪsᴛ.​
"""
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="ᴅᴏᴡɴʟᴏᴀᴅ ᴏʀ ᴜᴘʟᴏᴀᴅ ꜰᴀɪʟᴇᴅ...", callback_data=f"down"
            )
        ],
        [
            InlineKeyboardButton(
...
async def send_file(
    ...
    await CallbackQuery.edit_message_text(
        "» ᴜᴘʟᴏᴀᴅ sᴛᴀʀᴛᴇᴅ\n\nᴜᴘʟᴏᴀᴅɪɴɢ​ sᴘᴇᴇᴅ ᴄᴏᴜʟᴅ ʙᴇ sʟᴏᴡ, ᴘʟᴇᴀsᴇ ʜᴏʟᴅ ᴏɴ...",
        reply_markup=upl,
    )
    try:
